...
# ABOUTME: Multi-stage Dockerfile using FrankenPHP — dev image with xdebug + Panther, prod image on debian-slim.
# ABOUTME: Prod builder stage bakes assets (importmap, tailwind, asset-map compile) and dumps autoloader.
