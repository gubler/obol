...
A subscription is anything you pay for on a repeating schedule. Each one tracks its cost, how often it renews, and when the next payment is due.
...
Only the name, cost, and next renewal date are required.

## Editing a subscription

Open a subscription from the dashboard to see its full details and history, then select **Edit** to change any field. Saving records the change in the subscription's **History**, so you can see how its cost has changed over time.

## Archiving and deleting

- **Archive** hides a subscription from the dashboard's active views while keeping all of its history. Use it for things you've cancelled but want a record of. Archived subscriptions reappear when you turn on **Show archived**, and you can **Unarchive** them at any time.
- **Delete** removes a subscription and its history permanently. You'll be asked to confirm.
