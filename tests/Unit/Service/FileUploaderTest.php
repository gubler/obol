...
final class FileUploaderTest extends TestCase
{
    ...
    public function testUploadReturnsRelativePathUsingConfiguredPublicPath(): void
    {
        $uploader = new FileUploader(targetDirectory: $this->targetDirectory, publicPath: 'uploads/logos');
        $file = self::createTempUploadedFile();
    ...
    public function testUploadReturnsRelativePathForCustomPublicPath(): void
    {
        ...
        self::assertStringStartsWith('media/icons/', $result);
    }
    ...
    public function testUploadGeneratesUniqueFilenames(): void
    {
        ...
        $file1 = self::createTempUploadedFile();
        $file2 = self::createTempUploadedFile();
